...
public class PutGenericDaoNotificationRegistrationInternalRequest extends AbstractCreateNotificationRequest {
    ...
    public PutGenericDaoNotificationRegistrationInternalRequest(final String daoType, final String notificationEndPoint) {
        super(notificationEndPoint);
        this.daoType = daoType;
        
        this.updateQueryParam("dao_type", daoType);


    }

    public PutGenericDaoNotificationRegistrationInternalRequest withFormat(final HttpResponseFormatType format) {
        this.format = format;
    ...
    public PutGenericDaoNotificationRegistrationInternalRequest withNamingConvention(final NamingConventionType namingConvention) {
    ...
    public PutGenericDaoNotificationRegistrationInternalRequest withNotificationHttpMethod(final RequestType notificationHttpMethod) {
